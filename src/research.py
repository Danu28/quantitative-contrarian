...
def main():
    ...
    parser.add_argument("--top-frac", type=float, default=0.1, help="Top fraction labeled as winners")
    parser.add_argument("--window", type=int, default=20, help="Characteristic rolling window")
    parser.add_argument("--db", default=str(DB_PATH), help="SQLite DB path")
    args = parser.parse_args()
    scan(universe_slug_or_path=args.universe, years=args.years, horizon=args.horizon,
         top_frac=args.top_frac, window=args.window, db_path=args.db)
