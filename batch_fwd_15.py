...
strategy = getattr(args, "strategy", "factor")

results = []
for d in DATES:
    r = subprocess.run([sys.executable, "forward_check.py", "--date", d, "--universe", args.universe, "--strategy", strategy, "--top", "5"],
